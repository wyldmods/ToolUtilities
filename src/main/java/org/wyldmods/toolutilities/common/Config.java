...
public class Config
{
    ...
    public static void doConfig(File file)
    {
        ...
        allowPlace = config.get("Features Allowed", "allowPlace", true).getBoolean();
        allow3x1Pick = config.get("Features Allowed", "allow3x1Pick", true).getBoolean();
        allow3x1Shovel = config.get("Features Allowed", "allow3x1Shovel", true).getBoolean();
        allow3x1Axe = config.get("Features Allowed", "allow3x1Axe", true).getBoolean();
        allow3x3Pick = config.get("Features Allowed", "allow3x3Pick", true).getBoolean();
        allow3x3Shovel = config.get("Features Allowed", "allow3x3Shovel", true).getBoolean();
        allow3x3Hoe = config.get("Features Allowed", "allow3x3Hoe", true).getBoolean();
